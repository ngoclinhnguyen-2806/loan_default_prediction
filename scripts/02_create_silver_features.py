...
for date_str in dates_str_lst:
    data_processing_silver_table.process_silver_features(date_str, bronze_directory, silver_directory, spark, file_naming="date_specific")
